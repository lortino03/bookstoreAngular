...
@Component({
  selector: 'app-liste-auteurs-utilisateurs',
  templateUrl: './liste-auteurs-utilisateurs.component.html',
  styleUrls: ['./liste-auteurs-utilisateurs.component.css']
})
export class ListeAuteursUtilisateursComponent implements OnInit {
